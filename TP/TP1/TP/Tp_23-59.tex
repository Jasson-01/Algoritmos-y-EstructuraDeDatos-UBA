...
\begin{tad}{Berretacoin}{}
	...
	\begin{proc}{maximosTenedores}{\In b : Berretacion}{\TLista{Usuario}}
		...
		\paraTodo[unalinea]{u}{Usuario}{u \in res \implica usuarioDeBloque(cb,u) \wedge \\
		\paraTodo[unalinea]{v}{Usuario}{usuarioDeBloque(cb,v) \implica \\ (ventasEnLaCadenaBloques(cb,v)-comprasEnLaCadenaBloques(cb,v)) \leq \\ (ventasEnLaCadenaBloques(cb,u)-comprasEnLaCadenaBloques(cb,u)})  }
		}
