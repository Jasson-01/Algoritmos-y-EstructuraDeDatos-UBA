...
public class Heap<T extends Comparable<T>> {
    ...
    public  ArrayList<Tupla> siftUp(int i) {
        ...
        ArrayList<Tupla> intercambios = new ArrayList<>();
        ...
        while (i > 0) {
            ...
            if (array.get(i).compareTo(array.get(padre)) > 0) {
                ...
                // Registrar AMBOS elementos que se intercambiaron
                intercambios.add(new Tupla(i, array.get(i)));
                intercambios.add(new Tupla(padre, array.get(padre)));
        ...
        // Si no hubo intercambios, registrar la posición final
        ...
        while (i > 0) {  // Hasta log n iteraciones
            ...
            if (array.get(i).compareTo(array.get(padre)) > 0) { // O(1)
                swap(i, padre); // O(1)
                Tupla t = new Tupla(padre, array.get(padre));
                swapeado.add(t);
    ...
    public ArrayList<Tupla>  siftDown(int i) {
        ...
        while (true) {
            ...
            if (izq < n && array.get(izq).compareTo(array.get(mayor)) > 0) {
                mayor = izq;
            }

            if (der < n && array.get(der).compareTo(array.get(mayor)) > 0) {
                mayor = der;
            }
            ...
            if (mayor != i) {
                ...
                // Registrar AMBOS elementos que se intercambiaron
                intercambios.add(new Tupla(i, array.get(i)));
                intercambios.add(new Tupla(mayor, array.get(mayor)));
